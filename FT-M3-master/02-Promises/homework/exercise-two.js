 ...
 */
  ...
  let p1 = promisifiedReadFile('poem-two/stanza-01.txt').then(stanza1=>blue(stanza1));
  let p2 = promisifiedReadFile('poem-two/stanza-02.txt').then(stanza2=>blue(stanza2));
  let p3 = promisifiedReadFile('poem-two/stanza-03.txt').then(stanza3=>blue(stanza3));
  let p4 = promisifiedReadFile('poem-two/stanza-04.txt').then(stanza4=>blue(stanza4));
  let p5 = promisifiedReadFile('poem-two/st anza-05.txt').then(stanza5=>blue(stanza5));
  let p6 = promisifiedReadFile('poem-two/stanza-06.txt').then(stanza6=>blue(stanza6));
  let p7 = promisifiedReadFile('poem-two/stanza-07.txt').then(stanza7=>blue(stanza7));
  let p8 = promisifiedReadFile('poem-two/stanza-08.txt').then(stanza8=>blue(stanza8));
  */
...
*/
  ...
  // ???
    for(let i = 1, p=promisifiedReadFile(filenames[0]); i>= filenames.length; i++){
      p=p.then((stanza)=> { blue(stanza); if(i === filenames.length){ console.log('done')}
...
//  );
  ...
  if(i === filenames.length) p.catch(err=>{magenta(new Error(err));console.log('done')})
}
}
